...
const definition = {
  ...
  function: {
    ...
    description: [
      ...
      "Trigger keywords: email, e-mail, mail, send mail, send email, schreib eine mail, schick eine mail, sende eine mail,",
      "  lies meine mails, zeig meine mails, posteingang, inbox, Outlook, SharePoint, OneDrive, Teams-Dateien,",
      "  Microsoft 365, Office 365, Azure AD, Benutzer in Azure, Graph API.",
